--Be sure to drop the tables in your database from the Lab 1 assignment.

DROP TABLE IF EXISTS PROPERTY;
DROP TABLE IF EXISTS PROPOWNER;
...
CREATE TABLE PROPOWNER (
    PROPOWNER_ID CHAR(5) PRIMARY KEY NOT NULL,
...
CREATE TABLE PROPERTY (
    ...
    ADDRESS VARCHAR(100) NOT NULL,
    SQR_FT DECIMAL(6,2) NOT NULL,
    BDRMS INT NOT NULL,
    FLOORS INT NOT NULL,
    MONTHLY_RENT DECIMAL(6,2) NOT NULL,
    PROPOWNER_ID CHAR(5) NOT NULL
	CONSTRAINT PROPOWNERFK	FOREIGN KEY (PROPOWNER_ID)
					REFERENCES PROPOWNER(PROPOWNER_ID)
);

-- Insert owners
INSERT INTO PROPOWNER VALUES('MO100','Moore','Eleanor','8006 W. Newport Ave.','Vegas','NV','89508');
INSERT INTO PROPOWNER VALUES('PA101','Patel','Makesh','7337 Sheffield St.','Tacoma','WA','98119');
INSERT INTO PROPOWNER VALUES('AK102','Atkins','Carl','411 Griffin Rd.','Tacoma','WA','98131');
INSERT INTO PROPOWNER VALUES('CO103','Cole','Martin','9486 Circle Ave.','Olympia','WA','98506');
INSERT INTO PROPOWNER VALUES('KO104','Kowalczyk','Jacob','7431 S. Bishop St.','Bellingham','WA','98226');
INSERT INTO PROPOWNER VALUES('SI105','Sims','Haydon','527 Primrose Rd.','Eugene','OR','97203');
INSERT INTO PROPOWNER VALUES('BU106','Burke','Edward','613 Old Pleasant St.','Bozeman','MT','83303');
INSERT INTO PROPOWNER VALUES('BE107','Bidman','Seth','7681 Fordham St.','Tacoma','WA','98119');
INSERT INTO PROPOWNER VALUES('LO108','Lopez','Janette','9856 Pumpkin Hill Ln.','Everett','WA','98213');
INSERT INTO PROPOWNER VALUES('BI109','Bianchi','Nicole','7990 Willow Dr.','New York','NY','10005');
INSERT INTO PROPOWNER VALUES('JO110','Jones','Amanda','730 Military Ave.','Tacoma','WA','98126');
INSERT INTO PROPOWNER VALUES('JA125','James','Mary','975 Army Way.','Hartford','CT','06101');
INSERT INTO PROPOWNER VALUES('BA025','Bateman','Justin','8505 Maple Rd.','Fairfield','CT','06824');
...
INSERT INTO PROPERTY VALUES('12','2','2 Bow Ridge Ave.','1400','3','2',1700,'BE107');
INSERT INTO PROPERTY VALUES('13','2','16 Bainbridge Ave.','1600','3','2',1850,'BA025');
INSERT INTO PROPERTY VALUES('14','1','9450 Walnut Ave.','1000','1','1',1200,'JA125');
...
-- Insert offices 
INSERT INTO OFFICE VALUES('1','SSC-Lakewood','1135 N. Wells Avenue','Lakewood','Tacoma','WA','98118');
INSERT INTO OFFICE VALUES('2','SSC-Georgetown','986 S. Madison Rd','Georgetown','Tacoma','WA','98108');
...
INSERT INTO SERVICE_CATEGORY VALUES('5','Framing');
...
INSERT INTO RESIDENTS VALUES('10','Amara ','DeSimone','4');
